...
public class ExpBottleEvent extends ProjectileHitEvent {
	...
	/**
	 * This method sets if the particle effect will be shown. This does not
	 * change the experience created.
	 * 
	 * @param showEffect
	 *            true indicates the effect will be shown, false indicates no
	...
	/**
	 * This method retrieves the amount of experience to be created. The number
	 * indicates a total amount to be divided into orbs.
	 * 
	...
	/**
	 * This method sets the amount of experience to be created. The number
	 * indicates a total amount to be divided into orbs.
	 * 
	 * @param exp
